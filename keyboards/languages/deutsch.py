...
menu = ['Rund/Kreis', 'Quadrat/Rechteck', 'Rohr', 'Blech/Band', 'Balken', 'U-Profil', 'Winkel', 'Sechskant',
        'Bewehrung', 'Kugel', 'Standardrechner',
        'Sprache ändern', 'Benutzerhandbuch']

menu_pipe = ['Rund', 'Profil', 'Hauptmenü']
menu_sheet = ['Blech', 'Band', 'Hauptmenü']
menu_roundBar = ['Rund', 'Kreis', 'Hauptmenü']
menu_squareBar = ['Quadrat', 'Rechteck', 'Hauptmenü']
menu_beam = ['T-Träger', 'I-Träger', 'Hauptmenü']
menu_channel = ['Gleichflanschig', 'Ungleichflanschig', 'Hauptmenü']
menu_corner = ['Gleichseitig', 'Ungleichseitig', 'Hauptmenü']
menu_armature = ['Material und Profil', 'Hauptmenü']
menu_hexagon = ['Material und Profilnummer', 'Hauptmenü']
menu_sphere = ['Materialklasse der Kugel', 'Hauptmenü']

menu_stainless = ['Hauptmenü', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_de = ['Hauptmenü', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Alle Rechner', 'Hauptmenü']
...
menu_materials = ['Edelstahl', 'Kohlenstoffstahl', 'Eisenbasierte Legierungen',
                  'Eisenfreie Legierungen', 'Aluminiumbasierte Legierungen', 'Magnesiumbasierte Legierungen', 'Kupferbasierte Legierungen']

menu_deutsch = ['Rundstange/Kreis', 'Vierkantstange/Rechteck', 'Rohr', 'Balken', 'U-Profil', 'Winkel', 'Sechskant', 'Bewehrung', 'Kugel',
        'Sprache ändern', 'Hauptmenü']
...
# menu_change_language = ['Englisch', 'Deutsch', 'Italienisch', 'Spanisch', 'Französisch', 'Japanisch', 'Chinesisch', 'Koreanisch',
#                         'Polnisch', 'Tschechisch', 'Slowakisch', 'Slowenisch', 'Russisch', 'Hauptmenü']


menu_pipe_de = ['Rund', 'Profil', 'Hauptmenü']
menu_roundBar_de = ['Hauptmenü']
menu_squareBar_de = ['Hauptmenü']
menu_beam_de = ['Größe 10', 'Größe 20', 'Größe 30', 'Größe 36', 'Größe 45', 'Hauptmenü']
menu_channel_de = ['Größe 5', 'Größe 6,5', 'Größe 8']
menu_corner_de = ['Nr. 4,5', 'Nr. 5', 'Nr. 6', 'Nr. 7']
menu_armature_de = ['Profilgröße 6', 'Profilgröße 8', 'Profilgröße 10', 'Profilgröße 12']
menu_hexagon_de = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_deutsch = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_deutsch:
    Keyboard_menu_deutsch.insert(i)
