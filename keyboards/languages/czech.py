...
menu = ['Kruh/kruh', 'Čtverec/obdélník', 'Trubka', 'List/pás', 'Nosník', 'Ocelový nosník', 'Úhel', 'Šestiúhelník',
        'Ocelová výztuž', 'Koule/koule', 'Standardní kalkulátor',
        'Změnit jazyk', 'Uživatelský průvodce']

menu_pipe = ['Kruhová', 'Profilová', 'Hlavní menu']
menu_sheet = ['List', 'Pás', 'Hlavní menu']
menu_roundBar = ['Kruh', 'Kroužek', 'Hlavní menu']
menu_squareBar = ['Čtverec', 'Obdélník', 'Hlavní menu']
menu_beam = ['Tavrový nosník', 'Dvojitý ocelový nosník', 'Hlavní menu']
menu_channel = ['Rovnoběžný kanál', 'Nerovnoběžný kanál', 'Hlavní menu']
menu_corner = ['Rovnostranný', 'Nerovnostranný', 'Hlavní menu']
menu_armature = ['Materiál a profil', 'Hlavní menu']
menu_hexagon = ['Materiál a číslo profilu', 'Hlavní menu']
menu_sphere = ['Značka materiálu koule', 'Hlavní menu']

menu_stainless = ['Hlavní menu', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_cz = ['Hlavní menu', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Všechny kalkulátory', 'Hlavní menu']
...
menu_materials = ['Nerezová ocel', 'Uhlíková ocel', 'Železné slitiny',
                  'Nekovové slitiny', 'Hliníkové slitiny', 'Hořčíkové slitiny', 'Měděné slitiny']

menu_czech = ['Kruhový prut/kruh', 'Čtvercový prut/obdélník', 'Trubka', 'Nosník', 'Kanál', 'Úhel', 'Šestiúhelník', 'Ocelová výztuž', 'Koule/koule',
        'Změnit jazyk', 'Hlavní menu']
...
# menu_change_language = ['Angličtina', 'Němčina', 'Italština', 'Španělština', 'Francouzština', 'Japonština', 'Čínština', 'Korejština',
#                         'Polština', 'Čeština', 'Slovenština', 'Ruština', 'Hlavní menu']

menu_pipe_cz = ['Kruh', 'Profil', 'Hlavní menu']
menu_roundBar_cz = ['Hlavní menu']
menu_squareBar_cz = ['Hlavní menu']
menu_beam_cz = ['Číslo 10', 'Číslo 20', 'Číslo 30', 'Číslo 36', 'Číslo 45', 'Hlavní menu']
menu_channel_cz = ['Velikost 5', 'Velikost 6.5', 'Velikost 8']
menu_corner_cz = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_cz = ['Číslo profilu 6', 'Číslo profilu 8', 'Číslo profilu 10', 'Číslo profilu 12']
menu_hexagon_cz = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_czech = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_czech:
    Keyboard_menu_czech.insert(i)
