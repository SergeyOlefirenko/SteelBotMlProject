...
menu = ["Cercle/Anneau", "Carré/Rectangle", "Tube", "Feuille/Bande", "Poutre", "Profilé en U", "Angle", "Hexagone",
        "Armature", "Sphère/Boule", "Calculatrice standard",
        "Changer de langue", "Guide de l'utilisateur"]

menu_pipe = ['Ronde', 'Profilée', 'Menu principal']
menu_sheet = ['Feuille', 'Bande', 'Menu principal']
menu_roundBar = ['Cercle', 'Anneau', 'Menu principal']
menu_squareBar = ['Carré', 'Rectangle', 'Menu principal']
menu_beam = ['Poutre en T', 'Poutre en I', 'Menu principal']
menu_channel = ['Aile égale', 'Aile inégale', 'Menu principal']
menu_corner = ['Côté égal', 'Côté inégale', 'Menu principal']
menu_armature = ['Matériau et profil', 'Menu principal']
menu_hexagon = ['Matériau et numéro de profil', 'Menu principal']
menu_sphere = ['Grade de matériau de sphère/boule', 'Menu principal']

menu_stainless = ['Menu principal', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_fr = ['Menu principal', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Toutes les calculatrices', 'Menu principal']
...
menu_materials = ["Acier inoxydable", "Acier au carbone", "Alliages à base de fer",
                  "Alliages sans fer", "Alliages à base d'aluminium", "Alliages à base de magnésium", "Alliages à base de cuivre"]

menu_french = ['Barre ronde/Cercle', 'Barre carrée/Rectangle', 'Tube', 'Poutre', 'Canal', 'Coin', 'Hexagone', 'Armature', 'Sphère/Boule',
        'Changer de langue', 'Menu principal']
...
# menu_change_language = ['Anglais', 'Allemand', 'Italien', 'Espagnol', 'Français', 'Japonais', 'Chinois', 'Coréen',
#                         'Polonais', 'Tchèque', 'Slovaque', 'Russe', 'Menu principal']


menu_pipe_fr = ['Ronde', 'Profilée', 'Menu principal']
menu_roundBar_fr = ['Menu principal']
menu_squareBar_fr = ['Menu principal']
menu_beam_fr = ['Taille 10', 'Taille 20', 'Taille 30', 'Taille 36', 'Taille 45', 'Menu principal']
menu_channel_fr = ['Taille 5', 'Taille 6.5', 'Taille 8']
menu_corner_fr = ['N° 4.5', 'N° 5', 'N° 6', 'N° 7']
menu_armature_fr = ['Taille de profil 6', 'Taille de profil 8', 'Taille de profil 10', 'Taille de profil 12']
menu_hexagon_fr = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_french = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_french:
    Keyboard_menu_french.insert(i)
