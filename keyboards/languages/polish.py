...
menu = ['Koło/pierścień', 'Kwadrat/prostokąt', 'Rura', 'Arkusz/pasek', 'Belka', 'Kanał', 'Kątownik', 'Sześciokąt',
        'Zbrojenie', 'Sfera/kula', 'Standardowy kalkulator',
        'Zmień język', 'Podręcznik użytkownika']

menu_pipe = ['Okrągła', 'Profilowana', 'Menu główne']
menu_sheet = ['Arkusz', 'Pasek', 'Menu główne']
menu_roundBar = ['Koło', 'Pierścień', 'Menu główne']
menu_squareBar = ['Kwadrat', 'Prostokąt', 'Menu główne']
menu_beam = ['Belka T', 'Belka dwuteowa', 'Menu główne']
menu_channel = ['Równoramienny', 'Nierównoramienny', 'Menu główne']
menu_corner = ['Równoboczny', 'Nierównoboczny', 'Menu główne']
menu_armature = ['Materiał i profil', 'Menu główne']
menu_hexagon = ['Materiał i numer profilu', 'Menu główne']
menu_sphere = ['Materiał kuli', 'Menu główne']

menu_stainless = ['Menu główne', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_pl = ['Menu główne', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Wszystkie kalkulatory', 'Menu główne']
...
menu_materials = ['Stal nierdzewna', 'Stal węglowa', 'Stopy żelaza',
                  'Stopy nieżelazne', 'Stopy aluminium', 'Stopy magnezu', 'Stopy miedzi']

menu_polish = ['Pręt okrągły/Koło', 'Pręt kwadratowy/Prostokąt', 'Rura', 'Belka', 'Kanał', 'Kątownik', 'Sześciokąt', 'Zbrojenie', 'Sfera/Kula',
        'Zmień język', 'Menu główne']
...
# menu_change_language = ['Angielski', 'Niemiecki', 'Włoski', 'Hiszpański', 'Francuski', 'Japoński', 'Chiński', 'Koreański',
#                         'Polski', 'Czeski', 'Słowacki', 'Rosyjski', 'Menu główne']

menu_pipe_pl = ['Okrągła', 'Profilowana', 'Menu główne']
menu_roundBar_pl = ['Menu główne']
menu_squareBar_pl = ['Menu główne']
menu_beam_pl = ['Numer 10', 'Numer 20', 'Numer 30', 'Numer 36', 'Numer 45', 'Menu główne']
menu_channel_pl = ['Rozmiar 5', 'Rozmiar 6.5', 'Rozmiar 8']
menu_corner_pl = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_pl = ['Numer profilu 6', 'Numer profilu 8', 'Numer profilu 10', 'Numer profilu 12']
menu_hexagon_pl = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_polish = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_polish:
    Keyboard_menu_polish.insert(i)
