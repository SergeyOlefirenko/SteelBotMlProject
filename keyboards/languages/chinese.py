...
menu = ['圆/环', '正方形/矩形', '管道', '板材/带钢', '梁', '槽钢', '角钢', '六角形',
        '钢筋', '球/球体', '标准计算器',
        '更改语言', '用户手册']

menu_pipe = ['圆形', '轮廓', '主菜单']
menu_sheet = ['板材', '带钢', '主菜单']
menu_roundBar = ['圆形', '环', '主菜单']
menu_squareBar = ['正方形', '矩形', '主菜单']
menu_beam = ['T梁', 'I梁', '主菜单']
menu_channel = ['等边槽钢', '非等边槽钢', '主菜单']
menu_corner = ['等边', '非等边', '主菜单']
menu_armature = ['材料和轮廓', '主菜单']
menu_hexagon = ['材料和轮廓编号', '主菜单']
menu_sphere = ['球体/球体材料', '主菜单']

menu_stainless = ['主菜单', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_zh = ['主菜单', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['所有计算器', '主菜单']
...
menu_materials = ['不锈钢', '碳钢', '铁基合金',
                  '非铁基合金', '铝合金', '镁合金', '铜合金']

menu_chinese = ['圆形杆/圆', '方形杆/矩形', '管道', '梁', '槽钢', '角钢', '六角形', '钢筋', '球/球体',
        '更改语言', '主菜单']
...
# menu_change_language = ['英语', '德语', '意大利语', '西班牙语', '法语', '日语', '中文', '韩语',
#                         '波兰语', '捷克语', '斯洛伐克语', '俄语', '主菜单']

menu_pipe_zh = ['圆形', '轮廓', '主菜单']
menu_roundBar_zh = ['主菜单']
menu_squareBar_zh = ['主菜单']
menu_beam_zh = ['编号 10', '编号 20', '编号 30', '编号 36', '编号 45', '主菜单']
menu_channel_zg = ['尺寸 5', '尺寸 6.5', '尺寸 8']
menu_corner_zh = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_zh = ['轮廓编号 6', '轮廓编号 8', '轮廓编号 10', '轮廓编号 12']
menu_hexagon_zh = ['轮廓 6', '轮廓 8', '轮廓 10', '轮廓 12']
...
Keyboard_menu_chinese = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_chinese:
    Keyboard_menu_chinese.insert(i)
