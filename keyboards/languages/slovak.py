...
menu = ['Kruh/krúžok', 'Štvorec/obdĺžnik', 'Trubka', 'Plát/pás', 'Nosník', 'Oceľový nosník', 'Uholník', 'Šesťhran',
        'Výstuž', 'Globus/kulatý objekt', 'Štandardný kalkulátor',
        'Zmeniť jazyk', 'Príručka používateľa']

menu_pipe = ['Okrúhla', 'Profilovaná', 'Hlavné menu']
menu_sheet = ['Plát', 'Pás', 'Hlavné menu']
menu_roundBar = ['Kruh', 'Krúžok', 'Hlavné menu']
menu_squareBar = ['Štvorec', 'Obdĺžnik', 'Hlavné menu']
menu_beam = ['Oceľový nosník T', 'Dvojitý oceľový nosník', 'Hlavné menu']
menu_channel = ['Rovnoramenný', 'Nerovnoramenný', 'Hlavné menu']
menu_corner = ['Rovnostranný', 'Nerovnostranný', 'Hlavné menu']
menu_armature = ['Materiál a profil', 'Hlavné menu']
menu_hexagon = ['Materiál a číslo profilu', 'Hlavné menu']
menu_sphere = ['Značka materiálu gule', 'Hlavné menu']

menu_stainless = ['Hlavné menu', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_sk = ['Hlavné menu', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Všetky kalkulátory', 'Hlavné menu']
...
menu_materials = ['Nerezová oceľ', 'Uhlíková oceľ', 'Železné zliatiny',
                  'Nekovové zliatiny', 'Hliníkové zliatiny', 'Horčíkové zliatiny', 'Medené zliatiny']

menu_slovak = ['Kruhový prút/Kruh', 'Štvorcový prút/Obdĺžnik', 'Trubka', 'Nosník', 'Kanál', 'Uholník', 'Šesťhranný prút', 'Výstuž', 'Globus/Kuľa',
        'Zmeniť jazyk', 'Hlavné menu']
...
# menu_change_language = ['Angličtina', 'Nemčina', 'Taliančina', 'Španielčina', 'Francúzština', 'Japončina', 'Čínština', 'Kórejčina',
#                         'Poľština', 'Čeština', 'Slovenčina', 'Ruština', 'Hlavné menu']

menu_pipe_sk = ['Okrúhla', 'Profilovaná', 'Hlavné menu']
menu_roundBar_sk = ['Hlavné menu']
menu_squareBar_sk = ['Hlavné menu']
menu_beam_sk = ['Číslo 10', 'Číslo 20', 'Číslo 30', 'Číslo 36', 'Číslo 45', 'Hlavné menu']
menu_channel_sk = ['Veľkosť 5', 'Veľkosť 6.5', 'Veľkosť 8']
menu_corner_sk = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_sk = ['Číslo profilu 6', 'Číslo profilu 8', 'Číslo profilu 10', 'Číslo profilu 12']
menu_hexagon_sk = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_slovak = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_slovak:
    Keyboard_menu_slovak.insert(i)
