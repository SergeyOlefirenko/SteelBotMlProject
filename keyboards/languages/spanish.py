...
menu = ['Círculo/Anillo', 'Cuadrado/Rectángulo', 'Tubo', 'Chapa/Tira', 'Viga', 'Perfil en U', 'Ángulo', 'Hexágono',
        'Armado', 'Esfera/Bola', 'Calculadora estándar',
        'Cambiar idioma', 'Guía del usuario']

menu_pipe = ['Redonda', 'Perfilada', 'Menú principal']
menu_sheet = ['Chapa', 'Tira', 'Menú principal']
menu_roundBar = ['Círculo', 'Anillo', 'Menú principal']
menu_squareBar = ['Cuadrado', 'Rectángulo', 'Menú principal']
menu_beam = ['Viga en T', 'Viga en I', 'Menú principal']
menu_channel = ['Flange igual', 'Flange desigual', 'Menú principal']
menu_corner = ['Lado igual', 'Lado desigual', 'Menú principal']
menu_armature = ['Material y perfil', 'Menú principal']
menu_hexagon = ['Material y número de perfil', 'Menú principal']
menu_sphere = ['Grado de material de esfera/bola', 'Menú principal']

menu_stainless = ['Menú principal', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_es = ['Menú principal', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Todas las calculadoras', 'Menú principal']
...
menu_materials = ['Acero inoxidable', 'Acero al carbono', 'Aleaciones basadas en hierro',
                  'Aleaciones sin hierro', 'Aleaciones basadas en aluminio', 'Aleaciones basadas en magnesio', 'Aleaciones basadas en cobre']

menu_spanish = ['Barra redonda/Círculo', 'Barra cuadrada/Rectángulo', 'Tubo', 'Viga', 'Canal', 'Esquina', 'Hexágono', 'Armado', 'Esfera/Bola',
        'Cambiar idioma', 'Menú principal']
...
# menu_change_language = ['Inglés', 'Alemán', 'Italiano', 'Español', 'Francés', 'Japonés', 'Chino', 'Coreano',
#                         'Polaco', 'Checo', 'Eslovaco', 'Ruso', 'Menú principal']

menu_pipe_es = ['Redonda', 'Perfilada', 'Menú principal']
menu_roundBar_es = ['Menú principal']
menu_squareBar_es = ['Menú principal']
menu_beam_es = ['Tamaño 10', 'Tamaño 20', 'Tamaño 30', 'Tamaño 36', 'Tamaño 45', 'Menú principal']
menu_channel_es = ['Tamaño 5', 'Tamaño 6.5', 'Tamaño 8']
menu_corner_es = ['N.º 4.5', 'N.º 5', 'N.º 6', 'N.º 7']
menu_armature_es = ['Tamaño de perfil 6', 'Tamaño de perfil 8', 'Tamaño de perfil 10', 'Tamaño de perfil 12']
menu_hexagon_es = ['Perfil 6', 'Perfil 8', 'Perfil 10', 'Perfil 12']
...
Keyboard_menu_spanish = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_spanish:
    Keyboard_menu_spanish.insert(i)
