...
menu = ["Cerchio/anello", "Quadrato/rettangolo", "Tubo", "Foglio/nastro", "Trave", "Profilato a U", "Angolo", "Esagono",
"Armatura", "Sfera/palla", "Calcolatrice standard",
"Cambia lingua", "Guida dell'utente"]

menu_pipe = ['Rotondo', 'Profilato', 'Menu principale']
menu_sheet = ['Foglio', 'Nastro', 'Menu principale']
menu_roundBar = ['Cerchio', 'Anello', 'Menu principale']
menu_squareBar = ['Quadrato', 'Rettangolo', 'Menu principale']
menu_beam = ['Trave a I', 'Doppia T', 'Menu principale']
menu_channel = ['Con uguali ali', 'Con ali non uguali', 'Menu principale']
menu_corner = ['Con tutti i lati uguali', 'Con lati non uguali', 'Menu principale']
menu_armature = ['Materiale e profilo', 'Menu principale']
menu_hexagon = ['Materiale e numero del profilo', 'Menu principale']
menu_sphere = ['Marca del materiale della sfera/palla', 'Menu principale']

menu_stainless = ['Menu principale', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
'03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_it = ['Menu principale', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Tutte le calcolatrici', 'Menu principale']
...
menu_materials = ['Acciaio inossidabile', 'Acciaio al carbonio', 'Leghe a base di ferro',
'Leghe senza ferro', 'Leghe a base di alluminio', 'Leghe a base di magnesio', 'Leghe a base di rame']

menu_italian = ['Barra tonda/cerchio', 'Barra quadrata/rettangolo', 'Tubo', 'Trave', 'Canale', 'Angolo', 'Esagono', 'Armatura', 'Sfera/palla',
'Cambia lingua', 'Menu principale']
...
# menu_change_language = ['Inglese', 'Tedesco', 'Italiano', 'Spagnolo', 'Francese', 'Giapponese', 'Cinese', 'Coreano',
# 'Polacco', 'Ceco', 'Slovacco', 'Russo', 'Menu principale']


menu_pipe_en = ['Rotondo', 'Profilato', 'Menu principale']
menu_roundBar_en = ['Menu principale']
menu_squareBar_en = ['Menu principale']
menu_beam_en = ['Numero 10', 'Numero 20', 'Numero 30', 'Numero 36', 'Numero 45', 'Menu principale']
menu_channel_en = ['Dimensione 5', 'Dimensione 6.5', 'Dimensione 8']
menu_corner_en = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_en = ['Numero del profilo 6', 'Numero del profilo 8', 'Numero del profilo 10', 'Numero del profilo 12']
menu_hexagon_en = ['Profilo 6', 'Profilo 8', 'Profilo 10', 'Profilo 12']
...
Keyboard_menu_italian = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_italian:
    Keyboard_menu_italian.insert(i)
