...
menu = ['Krog/krožnik', 'Kvadrat/pravokotnik', 'Cevelj', 'List/trak', 'Nosilec', 'Nosilec', 'Kot', 'Šestkotnik',
        'Ojačitev', 'Sfera/krogla', 'Standardni kalkulator',
        'Spremeni jezik', 'Uporabniški vodnik']

menu_pipe = ['Krožna', 'Profil', 'Glavni meni']
menu_sheet = ['List', 'Trak', 'Glavni meni']
menu_roundBar = ['Krog', 'Obroč', 'Glavni meni']
menu_squareBar = ['Kvadrat', 'Pravokotnik', 'Glavni meni']
menu_beam = ['Tavrov nosilec', 'Dvojni tavrov nosilec', 'Glavni meni']
menu_channel = ['Enakopolni', 'Neenakopolni', 'Glavni meni']
menu_corner = ['Enakostranični', 'Neenakostranični', 'Glavni meni']
menu_armature = ['Material in profil', 'Glavni meni']
menu_hexagon = ['Material in številka profila', 'Glavni meni']
menu_sphere = ['Znamka materiala krogle/krogle', 'Glavni meni']

menu_stainless = ['Glavni meni', '12Х18Н10Т', '10Х17Н13М2Т', '08Х18Н10Т', '08Х17Т', '03Х17Н14М2',
                  '03Х18Н11', '04Х18Н10', '12Х18Н9', '08Х18Н10', '12Х17', '12Х13']
menu_stainless_sl = ['Glavni meni', 'AISI-321H(X12CrNiTi18-9)', 'AISI-316Ti(X6CrNiMoTi17-12-2)',
...
menu_all_calculators = ['Vsi kalkulatorji', 'Glavni meni']
...
menu_materials = ['Nerjaveče jeklo', 'Ugljično jeklo', 'Železne zlitine',
                  'Neh železne zlitine', 'Aluminijeve zlitine', 'Magnezijeve zlitine', 'Bakrene zlitine']

menu_slovenian = ['Krogelni palica/krogla', 'Kvadratni palica/pravokotnik', 'Cevelj', 'Nosilec', 'Kanal', 'Kot', 'Šestkotnik', 'Ojačitev', 'Krogla/krogla',
        'Spremeni jezik', 'Glavni meni']
...
# menu_change_language = ['Angleščina', 'Nemščina', 'Italijanščina', 'Španščina', 'Francoščina', 'Japonščina', 'Kitajščina', 'Korejščina',
#                         'Poljščina', 'Češčina', 'Slovaščina', 'Ruščina', 'Glavni meni']

menu_pipe_sl = ['Krog', 'Profil', 'Glavni meni']
menu_roundBar_sl = ['Glavni meni']
menu_squareBar_sl = ['Glavni meni']
menu_beam_sl = ['Številka 10', 'Številka 20', 'Številka 30', 'Številka 36', 'Številka 45', 'Glavni meni']
menu_channel_sl = ['Velikost 5', 'Velikost 6.5', 'Velikost 8']
menu_corner_sl = ['№ 4.5', '№ 5', '№ 6', '№ 7']
menu_armature_sl = ['Številka profila 6', 'Številka profila 8', 'Številka profila 10', 'Številka profila 12']
menu_hexagon_sl = ['Profil 6', 'Profil 8', 'Profil 10', 'Profil 12']
...
Keyboard_menu_slovenian = ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
for i in menu_slovenian:
    Keyboard_menu_slovenian.insert(i)
